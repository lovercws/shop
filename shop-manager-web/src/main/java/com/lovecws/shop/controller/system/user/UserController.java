...
public class UserController {
	 ...
	 * @param qemail 用户邮件
	 * @param qphone 用户手机号码
	 * @param currentPage 分页数量
	 * @param request
	 * @return
	 */
	@RequestMapping(value={"/list"},method=RequestMethod.GET)
	public String list(String quserName,String qnickName,String qemail,String qphone,String currentPage,HttpServletRequest request) {
		log.info("获取用户列表[quserName="+quserName+",qnickName="+qnickName+",qemail="+qemail+",qphone="+qphone+",currentPage="+currentPage+"]");
		int current_page=1;
		...
		//查询数据字典
		List<SysUser> users=userService.querySysUserByCondition(quserName,qnickName,qemail,qphone,PublicEnum.NORMAL.value(),pageParam);
		//组装分页实体对象
	...
	public String edit(String userId,String quserName,String qnickName,String qemail,String qphone,String currentPage,HttpServletRequest request){
	...
	public String update(SysUser user,String quserName,String qnickName,String qemail,String qphone,String currentPage,HttpServletRequest request){
	...
	public String delete(String userId,String quserName,String qnickName,String qemail,String qphone,String currentPage,HttpServletRequest request){
